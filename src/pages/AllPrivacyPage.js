...
const privacyLinks = [
  {
    name: 'ACKaraca.me',
    description: 'Bu sitenin genel gizlilik politikasi',
    url: '/privacy',
  },
  {
    name: 'WhereToGo',
    description: 'WhereToGo uygulamasi gizlilik politikasi',
    url: '/wheretogo/privacy',
  },
];

const AllPrivacyPage = () => {
  return (
    <main className="min-h-screen bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="space-y-3">
          <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white">Tum Uygulamalar - Gizlilik Politikalari</h1>
          <p className="text-slate-600 dark:text-slate-300">
            Bu sayfada projeler ve uygulamalar icin mevcut gizlilik dokumanlari baglantilarini bulabilirsiniz.
          </p>
        </header>
