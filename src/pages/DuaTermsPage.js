    ...
    <div className="min-h-screen py-16 bg-slate-900 text-white">
      <div className="container-custom">
        ...
        <div className="prose prose-invert max-w-none text-secondary-300">
          ...
          <p>
            Uygulama içeriği ve tasarımı DuaApp'a aittir. İzinsiz kopyalama, dağıtım veya değiştirme
            yasaktır.
          </p>

          <h2>6. AI Hizmetleri</h2>
          <p>
            AI özellikleri bilgilendirme amaçlıdır ve profesyonel dini veya hukuki görüş yerine
            geçmez. Sonuçlar garanti edilmez.
          </p>

          <h2>7. Ödeme ve Abonelik</h2>
          <p>
            Premium abonelikler otomatik yenilenebilir. İptal işlemleri bir sonraki dönem için
            geçerlidir. İadeler uygulama mağazası politikalarına tabidir.
          </p>

          <h2>8. Sorumluluk Reddi</h2>
          <p>DuaApp içeriklerin doğruluğunu garanti etmez; uygulama olduğu gibi sunulur.</p>

          <h2>9. Değişiklikler</h2>
          <p>Bu koşulları değiştirme hakkımız saklıdır; önemli değişiklikler bildirilecektir.</p>

          <h2>10. İletişim</h2>
          <p>Sorularınız için: destek@duaapp.com</p>
        </div>
      </div>
    </div>
  );
