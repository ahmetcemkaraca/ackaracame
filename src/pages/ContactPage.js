...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Mesaj gonderilirken bir hata olustu. Lutfen daha sonra tekrar deneyin.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="min-h-screen relative flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-background-light dark:bg-background-dark overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(25,127,230,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(25,127,230,0.05)_1px,transparent_1px)] bg-[length:40px_40px] pointer-events-none z-0" />
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-white/40 to-transparent dark:from-black/20 dark:to-transparent pointer-events-none z-0" />
        ...
        <div className="lg:col-span-5 flex flex-col justify-center space-y-10">
          <div className="space-y-4">
            <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white">
              Birlikte yeni bir seyler <br /> <span className="text-primary">insa edelim.</span>
            </h1>
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-md leading-relaxed">
              Serbest tasarim projeleri ve isbirlikleri icin iletisime gecebilirsiniz.
            </p>
          </div>
          ...
          <div className="mt-8 relative h-48 w-full rounded-xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-700 group">
            ...
            <div className="absolute bottom-4 left-4 flex items-center space-x-2 text-white">
              ...
              <span className="font-medium tracking-wide text-sm">Antalya, Turkiye</span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm p-8 lg:p-10 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700/50">
            {submitted ? (
              <div className="text-center flex flex-col items-center justify-center py-12">
                ...
                <h2 className="text-2xl font-bold mb-2 text-slate-900 dark:text-white">Mesajiniz Gonderildi!</h2>
                <p className="text-slate-600 dark:text-slate-400 mb-6">En kisa surede size donus yapacagim.</p>
                <button
              ...
              <>
                <h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white">Mesaj Gonder</h2>
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      name="subject"
                      type="text"
                      placeholder="Proje, Isbirligi, vb."
