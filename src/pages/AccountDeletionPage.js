...
const AccountDeletionPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!selectedApp) {
      setError('Lutfen hesap silme talebi gondereceginiz uygulamayi secin.');
      return;
    }
    if (!confirmed) {
    ...
    try {
      await ContactService.sendMessage({
        ...
        subject: `${selectedApp} - Account Deletion Request`,
              ...
              {sent ? (
                ...
                <>
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Uygulamalar Hesap Silme</h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-slate-700 dark:text-slate-300" htmlFor="application">
                        Uygulama
                      </label>
                      <select
                        id="application"
