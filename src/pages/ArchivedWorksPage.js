...
import { ArrowLeft, ChevronDown, ArrowRight, ExternalLink } from 'lucide-react';
                      ...
                      <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="flex-grow flex flex-col justify-center">
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <span className="hidden md:flex w-10 h-10 items-center justify-center rounded-full bg-slate-100 dark:bg-background-dark text-slate-400 group-hover:bg-primary group-hover:text-white transition-all cursor-pointer">
