        ...
        <div className="max-w-7xl mx-auto px-6 py-12 lg:px-12 lg:py-16">
              ...
              <div className="flex flex-wrap gap-2 md:justify-end">
                {categories.map(cat => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full border text-xs font-medium uppercase tracking-wide transition-all ${filter === cat
          ...
          <div className="mt-24 pt-8 border-t border-slate-200 dark:border-slate-800 text-slate-500 font-mono text-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex gap-6">
              <a className="hover:text-primary transition-colors" href="https://instagram.com" target="_blank" rel="noreferrer">&gt; Instagram</a>
              <a className="hover:text-primary transition-colors" href="https://linkedin.com" target="_blank" rel="noreferrer">&gt; LinkedIn</a>
              <a className="hover:text-primary transition-colors" href="https://github.com" target="_blank" rel="noreferrer">&gt; GitHub</a>
            </div>
          </div>
        </div>
      </main>
