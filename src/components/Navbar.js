    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to="/" className="text-xl font-bold tracking-widest group flex items-center gap-1 text-slate-900 dark:text-white">
            <img
              src="/276a1eae-4442-4dd4-8482-c24ac8fe3423.jpg"
              alt="ACKaraca.me logo"
              className="w-8 h-8 rounded object-cover mr-2 border border-slate-200 dark:border-slate-700"
            />
            ACKaraca<span className="text-primary group-hover:text-primary-hover transition-colors">.</span>me
          </Link>
              ...
              <Link
                ...
                className={`px-3 py-2 text-sm font-medium transition-colors rounded-md ${
                  location.pathname === item.href
                    ? 'text-primary'
                    : 'text-slate-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary hover:bg-gray-100 dark:hover:bg-slate-800/50'
                }`}
              >
                {item.name}
              </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="p-2 rounded-md text-slate-700 dark:text-slate-300 hover:text-primary hover:bg-gray-100 dark:hover:bg-slate-800/60 transition-colors"
            ...
            {user ? (
              <div className="flex items-center space-x-3 pl-3 border-l border-gray-200 dark:border-slate-700">
                <span className="text-xs text-slate-600 dark:text-gray-400 truncate max-w-[100px]">{user.email}</span>
